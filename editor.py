...
# Import the BASIC interpreter class from our interpreter module.
...
# --------------------
# Integrated Editor / Interpreter / Console Runner
# --------------------
    ...
    while running:
        for event in pygame.event.get():
            if event.type == QUIT:
                ...
                # If the mouse is in the footer area, use it to switch modes.
        ...
        if current_mode == "run" and prev_mode != "run":
            # When switching to run mode, reset the interpreter with the current editor contents.
